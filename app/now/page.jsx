		...
		<main className="min-h-screen bg-transparent">
			...
			<section className="relative pt-28 md:pt-36 pb-12 md:pb-16 overflow-hidden">
				<div className="pointer-events-none absolute inset-0 -z-10">
					<div className="absolute -top-12 right-1/4 h-72 w-72 rounded-full bg-emerald-50 dark:bg-emerald-500/10 blur-3xl opacity-70" />
					<div className="absolute top-1/3 left-0 h-64 w-64 rounded-full bg-blue-50 dark:bg-blue-500/10 blur-3xl opacity-60" />
				</div>
				...
				<div className="mx-auto max-w-7xl px-6 sm:px-10 lg:px-16">
					...
					<div className="flex flex-wrap items-end gap-3 mb-3">
						<p className="text-[11px] font-bold uppercase tracking-[.35rem] text-gray-400 dark:text-gray-500">
							/now
						</p>
					...
					<h1 className="text-gray-900 dark:text-white text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-[1.05] tracking-tight max-w-3xl mb-5">
					...
					<p className="text-gray-600 dark:text-gray-400 text-base sm:text-lg leading-relaxed max-w-2xl">
						...
						<a
							...
							className="underline decoration-gray-300 dark:decoration-gray-600 hover:decoration-gray-900 dark:hover:decoration-white"
						>
					...
					{updated && (
						<p className="text-xs text-gray-400 dark:text-gray-500 mt-4">
							Last updated <span className="text-gray-500 dark:text-gray-400 font-medium">{updated}</span>
						</p>
					)}
				</div>
			</section>
			...
			<section className="pb-24 md:pb-32">
				<div className="mx-auto max-w-7xl px-6 sm:px-10 lg:px-16">
						...
						{ITEMS.map((item, i) => {
							...
							return (
								<motion.div
									...
									className="rounded-2xl border border-gray-100 dark:border-white/10 bg-gradient-to-b from-white to-gray-50/60 dark:from-white/[0.03] dark:to-transparent p-6 sm:p-7 shadow-sm hover:shadow-md transition"
								>
					...
					<div className="mt-12 rounded-2xl border border-gray-100 dark:border-white/10 bg-white dark:bg-white/[0.03] p-6 sm:p-8 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4">
						<div>
							<h3 className="text-base font-semibold text-gray-900 dark:text-white mb-1">
								Want to talk about any of this?
							</h3>
							<p className="text-sm text-gray-500 dark:text-gray-400">I&apos;m almost always up for a good chat.</p>
						</div>
						<Link
							href="/contact"
