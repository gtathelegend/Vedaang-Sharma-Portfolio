...
export default function Footer() {
	return (
		<footer className="bg-gradient-to-b from-[#FFFBEB]/80 to-[#FAFAF9]/80 dark:bg-gray-50 border-t border-amber-200/40 dark:border-gray-200">
			{/* CTA strip */}
			...
			{/* Link columns */}
			<div className="mx-auto max-w-7xl px-6 sm:px-10 lg:px-16 py-10 border-t border-amber-100/60 dark:border-gray-200">
				<div className="grid grid-cols-2 md:grid-cols-4 gap-8">
					{/* Brand column */}
					<div className="col-span-2 md:col-span-1">
						<p className="text-base font-bold text-gray-900 mb-1">Vedaang Sharma</p>
			...
			{/* Copyright */}
			<div className="flex justify-center items-center py-4 border-t border-amber-100/60 dark:border-gray-200">
